...
export default function KambazNavigation() {
 return (
   <ListGroup className="rounded-0 position-fixed bottom-0 top-0 d-none d-md-block bg-dark z-2" style={{ width: 120 }}
              id="wd-kambaz-navigation">
     <ListGroupItem className="bg-dark border-0 text-center" as="a"
    ...
    <Link href="/Settings" id="wd-settings-link" className="text-white text-decoration-none">
        <FaGear className="fs-1 text-white" />
        <br />
        Settings
    </Link>
    </ListGroupItem>
